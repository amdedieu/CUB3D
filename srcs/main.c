...
/*   Updated: 2021/09/06 12:43:14 by amdedieu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cub3d(t_param *param)
{
	...
	param->mlx.img_ptr = mlx_new_image(param->mlx.mlx_ptr, param->resolution.x,
			param->resolution.y);
	param->mlx.img_addr = (unsigned int *)mlx_get_data_addr(param->mlx.img_ptr,
	...
	mlx_hook(param->mlx.win_ptr, 17, 0L, leave_prog, param);
